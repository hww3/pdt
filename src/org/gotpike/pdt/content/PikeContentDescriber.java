package org.gotpike.pdt.content;
...
/**
 * Content type describer for Pike source files.
 * 
 * @author jploski
 */
public class PikeContentDescriber implements ITextContentDescriber
{
    ...
    public int describe(Reader contents, IContentDescription description) throws IOException
    {
        ...
        return
            line == null ||
            !line.startsWith("#!") ||
            !(line.indexOf("pike") != -1) ? INDETERMINATE : VALID;
    }
