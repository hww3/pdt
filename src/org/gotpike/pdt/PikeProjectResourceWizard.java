...
import org.gotpike.pdt.util.NatureUtilities;
 ...
 * </p>
 */
public class PikeProjectResourceWizard
	 ...
	 */
	public PikeProjectResourceWizard() {
	...
	private void createProject(
		...
		try {
			...
			NatureUtilities.addNature(projectHandle, Constants.PIKE_NATURE_ID);
	...
	protected void initializeDefaultPageImageDescriptor() {
		...
		setDefaultPageImageDescriptor(
            PikePluginImages.getDescriptor(
                PikePluginImages.IMG_NEW_PROJECT_WIZARD));
		//}
...
//			return true;
//		}
			boolean res = MessageDialogWithToggle.openQuestion(window.getShell(), ResourceMessages.getString("NewProject.perspSwitchTitle"), //$NON-NLS-1$
		ResourceMessages.format("NewProject.perspSwitchMessage", new Object[] { finalPersp.getLabel()})); //$NON-NLS-1$
        return res;
	}
