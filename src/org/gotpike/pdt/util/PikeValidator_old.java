 ...
 * @author jploski
 */
public class PikeValidator_old extends PikeValidatorBase
{
    private static PikeValidator_old instance;    
    
    private PikeValidator_old()
    {
     ...
     */
    public synchronized static PikeValidator_old instance()
    {
        if (instance == null) instance = new PikeValidator_old();
        return instance;
    }
