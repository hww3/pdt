...
public class ProcessExecutor
{
        ...
        throws InterruptedException, IOException
    {
        ...
        try
        {
            ...
            if (input.length() > 0)
            {
                ...
                // to support our client PikeValidator:
                ...
                // a "broken pipe" IOException because Pike does not wait
    ...
    /**
     * This method is for the benefit of PikeValidator and should not concern
     * other clients.
     * <p>
     * Configures this ProcessExecutor to ignore suspected broken pipe
     * exceptions while delivering input to the executed process. 
     * It is intended as a workaround for a situation in which the Pike
