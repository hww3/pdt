 ...
 */
public final class PikeAutoIndentStrategy extends DefaultIndentLineAutoEditStrategy
{
    private final PikePairMatcher bracketMatcher =
        new PikePairMatcher(PDTPlugin.getDefault().getLog());
    
    public PikeAutoIndentStrategy()
    {
    }
        ...
        IDocument document, DocumentCommand command)
    {
        ...
        {
            System.out.println(PikeEditorMessages
