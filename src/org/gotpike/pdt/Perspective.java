...
public class Perspective implements IPerspectiveFactory {
	...
	public void defineActions(IPageLayout layout) {
		// Add "new wizards".
		layout.addNewWizardShortcut("org.gotpike.pdt.wizards.newproject");//$NON-NLS-1$
		layout.addNewWizardShortcut("org.gotpike.pdt.wizards.newfile");//$NON-NLS-1$
...
//		layout.addShowViewShortcut("org.epic.core.views.browser.BrowserView");//$NON-NLS-1$
	...
	public static void switchPerspective(final String perspectiveId) {
		...
		final IWorkbench workBench = PDTPlugin.getDefault()
				.getWorkbench();
