...
public abstract class AbstractReplaceAction extends AbstractTextAction {
    ...
    /* (non-Javadoc)
     * @see de.loskutov.anyedit.popup.actions.AbstractTextAction#doTextOperation(org.eclipse.jface.text.IDocument, java.lang.String, int, int)
     */
    protected void doTextOperation(IDocument doc,
        ...
        for (int i = resultSet.getStartLine(); i < maxNbr; i++) {
            ...
            String newText = performReplace(line, map);
     ...
     */
    protected abstract String performReplace(String line, HashMap map);
