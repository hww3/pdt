 ...
 */
public class PikeTextHover implements ITextHover
{
    private static int MAX_INFO_LENGTH = 80;

    private TextEditor fTextEditor;

    public PikeTextHover(TextEditor editor)
    {
        super();
        fTextEditor = editor;
    }
    ...
    public String getHoverInfo(ITextViewer textViewer, IRegion hoverRegion)
    {
        ...
        if (text == null)
        {
            if (hoverRegion.getLength() == 0 &&
                "true".equals(System.getProperty("org.gotpike.pdt.hoverPartitionType")))
            {
        ...
        {
            ResourceBundle rb =
                ResourceBundle.getBundle("org.gotpike.pdt.quickreference");
            ...
            else
            {
                try
                {
                    ...
                    IAnnotationHover markerAnnotation =
                        new PikeAnnotationHover(fTextEditor);
                    int line =
