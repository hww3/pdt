 ...
 * @author jploski
 */
public class newPikePresentationReconciler extends PresentationReconciler
{        
    public newPikePresentationReconciler(IPreferenceStore prefs)
    {
...
//System.err.println("ColoringScanner.setRange " + offset + ":" + length);
        ...
        private TextAttribute attr(String type)
        {
            ...
            PDTPlugin p = PDTPlugin.getDefault();
        ...
        private Color getColor(PDTPlugin p, String colorPref)
        {
