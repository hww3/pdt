 ...
 * @author jploski
 */ 
public class PikeValidatorErrors
{
    private final Set errorMessages;
    private final ErrorMessage unknownErrorMessage;
    
    public PikeValidatorErrors()
    {
        unknownErrorMessage = new ErrorMessage(
            ResourceMessages.getString("PikeValidatorErrors.unknownErrorMessage"),
            ResourceMessages.getString("PikeValidatorErrors.unknownErrorMessage.descr"),
            true);
        
        errorMessages = new HashSet();
        
        ResourceBundle errorBundle = ResourceBundle.getBundle(
            "org.gotpike.pdt.errorsAndWarnings");
