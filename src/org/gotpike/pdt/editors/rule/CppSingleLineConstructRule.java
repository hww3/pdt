 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class CppSingleLineConstructRule implements IPredicateRule {
	 ...
	 * 
	 */
	public CppSingleLineConstructRule(String startSequence, String endSequence, 
	...
	public IToken evaluate(ICharacterScanner scanner, boolean resume) 
	{
		...
		int c= scanner.read();
		if (c == '#' && fColumn == scanner.getColumn())
		{
