...
/**
 * Double click strategy aware of Pike identifier syntax rules.
 */
public class PikeDoubleClickSelector implements ITextDoubleClickStrategy
{
     ...
     */
    public PikeDoubleClickSelector()
    {
        super();
    }
